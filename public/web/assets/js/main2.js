(function (window, document, $, undefined) {
    ...
    setInterval(function () {
        ...
        $("#day").empty().text(day);
        $("#hrs").empty().text(hours);
        $("#min").empty().text(minutes);
        $("#sec").empty().text(seconds);
    }, 1000);
