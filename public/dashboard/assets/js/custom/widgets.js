...
var KTWidgets = {
    init: function () {
        ...
        }(), t = document.getElementById("kt_charts_widget_1_chart"), a = parseInt(KTUtil.css(t, "height")), o = KTUtil.getCssVariableValue("--bs-gray-500"), s = KTUtil.getCssVariableValue("--bs-gray-200"), r = KTUtil.getCssVariableValue("--bs-primary"), i = KTUtil.getCssVariableValue("--bs-gray-300"), t && new ApexCharts(t, {
            series: [{
                name: "Net Profit",
        ...
        }(), (l = document.querySelector("#kt_forms_widget_1_form")) && l && new Quill("#kt_forms_widget_1_editor", {
        ...
        })), (d = document.querySelector("#kt_user_follow_button")) && d.addEventListener("click", (function (e) {
            e.preventDefault(), d.setAttribute("data-kt-indicator", "on"), d.disabled = !0, d.classList.contains("btn-success") ? setTimeout((function () {
                d.removeAttribute("data-kt-indicator"), d.classList.remove("btn-success"), d.classList.add("btn-light"), d.querySelector(".svg-icon").classList.add("d-none"), d.querySelector(".indicator-label").innerHTML = "Follow", d.disabled = !1
            }), 1500) : setTimeout((function () {
                d.removeAttribute("data-kt-indicator"), d.classList.add("btn-success"), d.classList.remove("btn-light"), d.querySelector(".svg-icon").classList.remove("d-none"), d.querySelector(".indicator-label").innerHTML = "Following", d.disabled = !1
            }), 1e3)
        })), function () {
