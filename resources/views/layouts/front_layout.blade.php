            ...
            <div class="header-navbar">
                <div class="header-brand">
                    ...
                    <a href="{{ url(\Illuminate\Support\Facades\App::getLocale().'/') }}" class="logo logo-dark">
                        <img
                            src="{{ Request::root() . '/dashboard/images/' . \App\Models\Settings::where('key_id' , 'logo')->first()->value }}"
                            alt="{{ env('APP_NAME') }}"
                            style="width: 130px; height:80px; /*object-fit:cover;*/ padding: 10px;">
...
{{--                                <a href="{{ url(app()->getLocale().'/') }}">{{ __('lang.Home') }}</a>--}}
                                <a href="#">{{ __('lang.Home') }}</a>
                                <ul class="axil-submenu">
                                    <li><a href="{{ route('home') }}/#hot-deal-this-week">{{ __('lang.Home1') }}</a>
                                    </li>
                                    ...
                                    <li><a href="{{ route('home') }}/#most-sold">{{ __('lang.Home5') }}</a></li>
...
{{--                                <a href="{{ route('product.index') }}">{{ __('lang.Products') }}</a>--}}
                                ...
                                <ul class="axil-submenu">
                                    ...
                                    <li>
                                        <a href="{{ url(\Illuminate\Support\Facades\App::getLocale().'/products/new-arrivals?type=new') }}">{{ __('lang.Products2') }}</a>
                                    </li>
                                    <li>
                                        <a href="{{ url(\Illuminate\Support\Facades\App::getLocale().'/products/most-sold?type=sold') }}">{{ __('lang.Products3') }}</a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <li class="my-account">
                            ...
                            <div class="my-account-dropdown">
                                ...
                                @else
                                    <div class="login-btn">
                                        <a href="{{ route('login') }}"
                                           class="axil-btn btn-bg-primary">{{ __('lang.Login') }}</a>
                                    </div>
                                @endif
                    ...
                    <a href="index.html">
                        ...
                        <div class="inner">
                            ...
                            <ul class="support-list-item">
                                <li>
                                    <a href="mailto:{{ \App\Models\Settings::where('key_id' , 'email')->first()->value }}"><i
                                            class="fal fa-envelope-open"></i>
                                        {{ \App\Models\Settings::where('key_id' , 'email')->first()->value }}</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-xl-4">
                    <div class="social-share">
                        <a href="{{ \App\Models\Settings::where('key_id' , 'facebook')->first()->value }}"><i
                                class="fab fa-facebook-f"></i></a>
                        <a href="{{ \App\Models\Settings::where('key_id' , 'Instagram')->first()->value }}"><i
                                class="fab fa-instagram"></i></a>
                        <a href="{{ \App\Models\Settings::where('key_id' , 'twitter')->first()->value }}"><i
    ...
    <div class="header-search-wrap">
        <div class="card-header">
            ...
            <div class="input-group">
                <input type="search" class="form-control name-filter" name="name-filter" id="prod-search"
