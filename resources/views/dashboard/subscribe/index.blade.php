...
@section('main_title', __('lang.subscribes'))
@section('header_title', __('lang.subscribes'))
    ...
    <div class="card mb-5 mb-xxl-8">
        ...
        <div class="card-header border-0 pt-5">
            ...
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted fw-bold fs-7">
                    {{ __('lang.sub_title_subscribe', ['count' => $subscribes->count()]) }}
                </span>
            </h3>
            <!--end::Title-->
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                ...
                <a href="{{ route('subscribe.sendMail') }}" class="btn btn-sm btn-light-primary">
        ...
        <div class="card-body py-3">
            ...
            <div class="table-responsive" id="table-data">
                <!--begin::Table-->
                @include('dashboard.subscribe.table-data')
            </div>
        </div>
        <!--end::Body-->
    </div>
