        ...
        <div class="card-body py-3">
            <form action="{{ route('countries.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-10">
                    ...
                    <input type="text" name="name_ar" class="form-control form-control-solid" value="{{ $country->name_ar }}">
                </div>

                <div class="mb-10">
                    <label class="form-label">{{ __('lang.nameen') }}</label>
                    <input type="text" name="name_en" class="form-control form-control-solid" value="{{ $country->name_en }}">
                </div>
                ...
                <div class="row ">
                    <div class="form-check form-switch form-check-custom form-check-solid col-3">
                        <input class="form-check-input" type="checkbox" name="status" id="flexSwitchChecked"
                               @if( $country->status == '1') checked="checked" @else @endif />
