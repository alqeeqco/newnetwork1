    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{ __('lang.titlecountries') }}</span>
            </h3>
            @can('Country-Create')
        ...
        <div class="card-body py-3">
            ...
            <div class="table-responsive" id="table-data">
                <!--begin::Table-->
                @include('dashboard.Countries.table-data')
            </div>
        </div>
    </div>
@endsection
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '#status' ,function (e){
            ...
            $.ajax({
                type: 'post',
                url: '{{ url('admin/countries/Stauts') }}/'+id,
                data: '',
        ...
        function delete_f(id) {
            $(document).off("click", "#save-delete").on("click", "#save-delete", function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{ url('admin/countries/destroy') }}/' + id,
                    data: '',
                    success: function (response) {
                        Swal.fire({
