<table class="table table-row-bordered gy-5" id="shippingoptions">
    <!--begin::Table head-->
    <thead>
        <tr class="fw-bold fs-6 text-muted text-center">
            ...
            <th>{{ __('lang.price') }}</th>
            <th>{{ __('lang.first_kilo') }}</th>
            <th>{{ __('lang.Price_kilo_after_first') }}</th>
            <th>{{ __('lang.status') }}</th>
            <th>{{ __('lang.actions') }}</th>
        </tr>
    </thead>
    <tbody>
    @foreach($shippingoptions as $i =>  $key)
...
{{--                            {{ mb_substr($key->name_ar , 0 , 10 , 'utf-8').' ...' }}--}}
            ...
            <td>
                    <div class="d-flex justify-content-start flex-column">
                        <p class="text-dark fw-bolder text-hover-primary fs-6">
                            {{ $key->first_cleo ?? __('lang.nothing') }}
                        </p>
                    </div>
            </td>
            <td>
                    <div class="d-flex justify-content-start flex-column">
                        <p class="text-dark fw-bolder text-hover-primary fs-6">
                            {{ $key->Price_kilo_after_first ?? __('lang.nothing') }}
                        </p>
                    </div>
            </td>
            <td>
            ...
            <td>
                    <a href="{{ url(\Illuminate\Support\Facades\App::getLocale().'/admin/shippingoptions/edit') }}/{{ $key->id }}"
