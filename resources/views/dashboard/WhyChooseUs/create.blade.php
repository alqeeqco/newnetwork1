        ...
        <div class="card-body py-3">
            <form action="{{ route('whychooseus.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-10">
                    ...
                    <input type="text" name="title_ar"  value="{{ old('title_ar' , '') }}" class="form-control form-control-solid">
                </div>

                <div class="mb-10">
                    <label class="form-label">{{ __('lang.titleen') }}</label>
                    <input type="text" name="title_en" {{ old('title_en' , '') }} class="form-control form-control-solid">
                </div>
