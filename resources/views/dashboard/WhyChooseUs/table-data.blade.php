<table class="table table-row-bordered gy-5" id="whychooseus">
    <!--begin::Table head-->
    <thead>
    ...
    @foreach($whychooseus as $i => $key)
        <tr class="text-center">
                ...
                <div class="d-flex justify-content-start flex-column">
                    <p class="text-dark fw-bolder text-hover-primary fs-6">
                        @if(\Illuminate\Support\Facades\App::getLocale() == 'en')
                            {{ mb_substr($key->title_en , 0 , 10 , 'utf-8').' ...' }}
                            {{ $key->title_en }}
                        @else
            ...
            <td>
                @can('Why-Choose-us-Edit')
                <a href="{{ url(\Illuminate\Support\Facades\App::getLocale().'/admin/whychooseus/edit') }}/{{ $key->id }}"
