                        ...
                        <div class="inner">
                            <ul class="axil-breadcrumb">
                                ...
                                @if(request()->get('type') == 'new')
                                    <li class="axil-breadcrumb-item active" aria-current="page">{{ __('lang.Products2') }}</li>
                                @elseif(request()->get('type') == 'sold')
                                    <li class="axil-breadcrumb-item active" aria-current="page">{{ __('lang.Products3') }}</li>
                                @else
