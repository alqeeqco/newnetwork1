        ...
        <div class="address-list">
            <div class="row">
                @foreach($addresses as $address)
                    <div class="col-sm-6">
                        <div class="card-adress" style="padding: 20px">
                            {{--                            <input type="radio" id="address-{{ $address->id }}"--}}
                            {{--                                     name="address_id" value="{{ $address->id }}">--}}
                            <label class="d-block w-100" for="address">
{{--                                <a class="btn btn-light-danger float-end w-md-25" id="delete_address" data-id="{{ $address->id }}">--}}
...
{{--                                </a>--}}
                                ...
                                <a class="btn btn-light-info float-end w-md-25" id="edite_address" data-id="{{ $address->id }}">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             width="24px" height="24px"
                                             viewBox="0 0 24 24" version="1.1">
...
{{--    <span class="text-capitalize">add address</span>--}}
{{--</button>--}}
