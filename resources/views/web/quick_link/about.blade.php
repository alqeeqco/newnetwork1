            ...
            <div class="row align-items-center">
                <div class="col-xl-4 col-lg-6">
                    <div class="about-thumbnail">
                        <div class="thumbnail">
{{--                            <img src="{{ asset('web/assets/images/about.png') }}" alt="About Us">--}}
                            <img src="{{ Request::root() . '/dashboard/images/' . App\Models\Settings::where('key_id' , 'contact-us')->first()->value }}" alt="About Us">
                        </div>
                    </div>
                </div>
